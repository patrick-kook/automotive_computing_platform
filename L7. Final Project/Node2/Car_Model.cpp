...
static int16_t saturate(int16_t val, int16_t min_val, int16_t max_val) {
...
int16_t control_rpm(uint16_t throttle_position, bool singal) {
    ...
    if (singal == true){
        ...
        throttle_position = saturate(throttle_position, 0, 1023);
