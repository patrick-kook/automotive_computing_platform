...
static VAR(OsEE_action, OS_CONST) osEE_expiry_point_st_SchedTab1_4_action_array[(2U)] = {
  {
    /* .param      = */   {
      /* .f            = */ NULL,
      /* .p_tdb        = */ &osEE_tdb_array[1U],
...
static VAR(OsEE_action, OS_CONST) osEE_expiry_point_st_SchedTab1_5_action_array[(2U)] = {
  {
    /* .param      = */   {
      /* .f            = */ NULL,
      /* .p_tdb        = */ &osEE_tdb_array[1U],
