...
.LC4:
	.string	"TaskH : Try Lock(M2). "
.LC5:
	.string	"TaskH : Get Lock(M2). "
.LC6:
	.string	"TaskH : Release Lock(M2). "
.LC7:
...
.LC9:
	.string	"<TaskL begins.> "
.LC10:
	.string	"TaskL : Try Lock(M2). "
.LC11:
	.string	"TaskL : Get Lock(M2). "
.LC12:
...
.L__stack_usage = 0
	...
	.section	.data.c.2346,"aw",@progbits
	.type	c.2346, @object
	.size	c.2346, 4
c.2346:
	.byte	-5
