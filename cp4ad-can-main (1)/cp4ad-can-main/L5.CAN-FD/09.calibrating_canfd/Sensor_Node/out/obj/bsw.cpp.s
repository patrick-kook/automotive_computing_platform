...
.L39:
	...
	sbc r27,r27
	sts car_input+4,r24
	sts car_input+4+1,r25
	sts car_input+4+2,r26
	sts car_input+4+3,r27
	ldd r24,Y+10
	ldd r25,Y+11
	eor r25,r24
	eor r24,r25
	...
	sbc r27,r27
	sts car_input+8,r24
	sts car_input+8+1,r25
	sts car_input+8+2,r26
	sts car_input+8+3,r27
	ldd r24,Y+14
	ldd r25,Y+15
	eor r25,r24
	eor r24,r25
	...
	sbc r26,r26
	sbc r27,r27
	sts car_input+12,r24
	sts car_input+12+1,r25
	sts car_input+12+2,r26
	sts car_input+12+3,r27
	ldi r24,lo8(.LC7)
	ldi r25,hi8(.LC7)
	push r25
	push r24
...
.L__stack_usage = 0
	...
	out 0x1c,r24
/* #APP */
 ;  229 "C:\Users\wjehe\DOWNLO~1\CP4AD-~1\CP4AD-~1\L517B7~1.CAN\09678D~1.CAL\SENSOR~1\bsw.cpp" 1
	sei
 ;  0 "" 2
/* #NOAPP */
	call init
