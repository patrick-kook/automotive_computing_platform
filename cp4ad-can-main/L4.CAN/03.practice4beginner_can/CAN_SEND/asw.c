...
TASK(Task1) {
	...
	buf_send[0] = (short_1 >> 8) & 0xff;
	buf_send[1] = (short_1 >> 0) & 0xff;

	buf_send[2] = (short_2 >> 8) & 0xff;
	buf_send[3] = (short_2 >> 0) & 0xff;

	buf_send[4] = (int_1 >> 24) & 0xff;
	buf_send[5] = (int_1 >> 16) & 0xff;
	buf_send[6] = (int_1 >> 8) & 0xff;
	buf_send[7] = (int_1 >> 0) & 0xff;
	///////////////////////////////////////////
